...
class ElectronicStructureBuilder(Builder):
    def __init__(
        ...
        **kwargs,
        ...
        self.electronic_structure = target_keys["electronic_structure"]
        ...
        fs_stores = [self.bandstructure_fs, self.dos_fs]
        ...
        super().__init__(
            sources=sources,
            targets=[self.electronic_structure],
    ...
    def get_processed_docs(self, mats):
        ...
        for mat_id in mats:
                ...
                if "NSCF Uniform" in mat["task_types"][task_id]:
                    ...
                    if fs_id is not None:
                        ...
                        if (
                            ...
                            nkpoints = np.prod(
                                task_query["orig_inputs"]["kpoints"]["kpoints"][0],
                                axis=0,
                            )
            ...
            all_docs.append(updated_materials_doc)
        ...
        for mat in items:
            ...
            if dos is None:
                ...
                try:
                    ...
                    doc = self._bsdos_checks(
                        doc, dos[mat["dos"]["task_id"]], structures
                    )
            ...
            if doc.dos is not None:
                ...
                mag_orderings.update(
                    {
                        dos_dict["total"][Spin.up]["task_id"]: dos_dict[
                            "magnetic_ordering"
                        ]
                    }
                )
    ...
    def update_targets(self, items):
        ...
        if len(items) > 0:
            ...
            self.electronic_structure.update(
                docs=jsanitize(items, allow_bson=self.allow_bson)
            )
        else:
